...
</ul></div></nav></div><header class="sc-bdvvaa itMAzf"><div font-size="24px" class="sc-bdvvaa jvOulc">Github Blog 만들기2 - table Of Contents 추가(by gatsby)</div><div color="#bbb" class="sc-bdvvaa djKbCW"></div></header><style data-emotion-css="8xh4e7">.css-8xh4e7{line-height:30px;position:static;}</style><div class="sc-bdvvaa itMAzf css-8xh4e7"><p>다른 블로그 돌아다니다 보니, 게시글에 대한 목차가 있는 게 뭔가 신기했다. 마크다운 문법 찾으며 정리하던 중에 이를 TOC 라고 하는 걸 알게 됐다. 내가 나중에 글 다시 읽을 때 유용할 거 같아 보여서 블로그에 해당 기능(?)을 추가하기로 마음 먹었다.  </p>
