...
<ul>
<li>
<p>단, 5%마다 출력할 때 int로 type casting 해야 한다.</p>
...
<ul>
<li>insight ?<br>
NAND / OR / AND 의 공통점 : 1개의 Logistic Regression로 표현할 수 있다.<br>
​
cf. FC Fully connection (완전 연결) : 이전 출력이 모두 다음의 입력으로 들어가는 것  </li>
</ul>
...
<ul>
<li>insight<br>
​변곡점이 있다면, 활성화 함수를 쓸 수 있다.<br>
다만, 변곡점 threshold (임계점) 기준으로 2가지 분류만 가능하다.</li>
</ul>
<p>=> 그럼 5개는 어떻게 나눌까?<br>
