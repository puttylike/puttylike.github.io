...
</ul></div></nav></div><header class="sc-bdvvaa itMAzf"><div font-size="24px" class="sc-bdvvaa jvOulc">AI 이노베이션 스퀘어 13기 기본반 18일차 후기</div><div color="#bbb" class="sc-bdvvaa djKbCW"></div></header><style data-emotion-css="8xh4e7">.css-8xh4e7{line-height:30px;position:static;}</style><div class="sc-bdvvaa itMAzf css-8xh4e7"><h3 id="18일차" style="position:relative;">18일차<a href="#18%EC%9D%BC%EC%B0%A8" aria-label="18일차 permalink" class="custom-class after"><svg aria-hidden="true" height="20" version="1.1" viewBox="0 0 16 16" width="20"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a></h3>
<ul>
...
<p>&#x3C;class 'tensorflow.python.keras.callbacks.History'><br>
dict<em>keys(['loss'])<br>
​
=> hist.history = dictionary 타입으로, keys:loss values:loss</em>val 는 기본적으로 들어 있다.</p>
